...
class Game:
    def __init__(self):
        ...
        self.assets = {
            ...
            'particle/leaf': Animation(load_images('particles/leaf'), image_dur=20, loop=False),
            'particle/particle': Animation(load_images('particles/particle'), image_dur=20, loop=False),
        }
